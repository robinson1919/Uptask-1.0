<?php 
    include_once 'inc/funciones/sesiones.php'; 
    include_once 'inc/templates/header.php';  
    include_once 'inc/funciones/funciones.php';  
    include_once 'inc/templates/barra.php';  

    // Optener el ID de la ULR
    $id_proyecto = '';
...
<?php
    include_once 'inc/templates/sidebar.php';   
?>
